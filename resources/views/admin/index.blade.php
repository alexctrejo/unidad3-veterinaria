...
@section('content')
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
            ...
            <div class="item">
                <div class="img-fill">
                    <img src="{{asset('images/carrousel-1.jpg')}}" alt="">
                    <div class="text-content">
                        <h3>Bienvenido</h3>
                        <h5>{{ $name }}</h5>
                        <a href="#" class="main-stroked-button">Mas información</a>
                        <a href="#" class="main-filled-button">Agenda ahora</a>
                    </div>
                </div>
            </div>
            <!-- // Item -->
            ...
            <div class="item">
                <div class="img-fill">
                    <img src="{{asset('images/carrousel-2.jpg')}}" alt="">
                    <div class="text-content">
                        <h3>Veterinaria Woof</h3>
                        <h5>Los mejores en el cuidado de las mascotas</h5>
                        <a href="#" class="main-stroked-button">Leer más</a>
                        <a href="#" class="main-filled-button">Información</a>
                    </div>
                </div>
            </div>
            <!-- // Item -->
            ...
            <div class="item">
                <div class="img-fill">
                    <img src="{{asset('images/carrousel-3.jpg')}}" alt="">
                    <div class="text-content">
                    ...
                    <div class="filters-content">
                        <div class="row grid">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-01.jpg')}}" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-01.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-02.jpg')}}" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-02.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all gra">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-03.jpg')}}" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-03.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all tsh">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-04.jpg')}}" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-04.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-05.jpg')}}" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-05.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                                <div class="item">
